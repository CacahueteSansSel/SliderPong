...
FONTFILES	:=	$(foreach dir,$(GRAPHICS),$(notdir $(wildcard $(dir)/*.otf)))
...
export EFONTFILES	:=  $(FONTFILES:.otf=.bcfnt)
#---------------------------------------------------------------------------------
else
#---------------------------------------------------------------------------------
export ROMFS_T3XFILES	:=	$(patsubst %.t3s, $(GFXBUILD)/%.t3x, $(GFXFILES))
export ROMFS_FONTFILES	:=	$(patsubst %.otf, $(GFXBUILD)/%.bcfnt, $(FONTFILES))
...
all: $(ROMFS_T3XFILES) $(ROMFS_FONTFILES) $(T3XHFILES) $(OUTPUT_FILE).zip $(OUTPUT_FILE).3ds $(OUTPUT_FILE).cia
